...
exports.downloadAndDeleteSalesReport = exports.getSalesReportFiles = exports.sales_report = exports.updateSalesReturnStatus = exports.create_update_payment = exports.read_SalesReturn = exports.createSalesReturn = exports.read = exports.create = void 0;
...
exports.sales_report = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const calculateGrossSalesSummary = (sales) => {
    ...
    const totalReturnValue = salesReturns.reduce((sum, returnItem) => sum + Number(returnItem.refundAmount || 0), 0);
    // Calculate return COGS (cost of returned items)
    const totalReturnCOGS = salesReturns.reduce((sum, returnItem) => {
        var _a, _b;
        const costPrice = ((_b = (_a = returnItem.originalSale) === null || _a === void 0 ? void 0 : _a.inventoryItem) === null || _b === void 0 ? void 0 : _b.costPrice) || 0;
    ...
    const summary = {
        ...
        totalDiscounts: sales.reduce((sum, sale) => sum + Number(sale.unitDiscount || 0), 0),
        ...
        totalReturnItems: salesReturns.reduce((sum, returnItem) => sum + returnItem.returnQuantity, 0),
        ...
        completedReturns: salesReturns.filter((r) => r.status === "APPROVED" || r.status === "PROCESSED").length,
    ...
    const calculateBreakdowns = (sales, salesReturns) => {
        const breakdowns = {
            // Payment Terms Breakdown
            paymentTerms: sales.reduce((acc, sale) => {
            ...
            salesStatus: sales.reduce((acc, sale) => {
            ...
            customerClassification: sales.reduce((acc, sale) => {
            ...
            // District Breakdown
            districtSales: sales.reduce((acc, sale) => {
            ...
            // PSR Performance
            psrPerformance: sales.reduce((acc, sale) => {
            ...
            // Product Analysis
            topProducts: sales.reduce((acc, sale) => {
            ...
            // Return Analysis
            returnReasons: salesReturns.reduce((acc, returnItem) => {
            ...
            // Return Status
            returnStatus: salesReturns.reduce((acc, returnItem) => {
    ...
    if (format === "excel") {
        ...
        sales.forEach((sale) => {
            var _a, _b, _c;
            const totalPaid = sale.payments.reduce((sum, payment) => sum + Number(payment.paymentAmount), 0);
            const totalAmount = Number(sale.unitFinalPrice);
            const row = salesWorksheet.addRow({
                status: sale.status,
                referenceNumber: sale.transactionID,
                customer: ((_a = sale.customer) === null || _a === void 0 ? void 0 : _a.customerName) || sale.customerName || "N/A",
                ...
                productCategories: ((_b = sale.inventoryItem.product.categories) === null || _b === void 0 ? void 0 : _b.map((c) => c.name).join(", ")) || "N/A",
                ...
                createdBy: ((_c = sale.createdBy) === null || _c === void 0 ? void 0 : _c.fullname) || "N/A",
        ...
        salesReturns.forEach((returnItem) => {
            ...
            const row = returnsWorksheet.addRow({
                ...
                customer: ((_a = returnItem.originalSale.customer) === null || _a === void 0 ? void 0 : _a.customerName) ||
                ...
                returnAmount: Number(returnItem.refundAmount || 0).toLocaleString("en-US"),
                returnReason: returnItem.returnReason,
                restockable: returnItem.restockable ? "Yes" : "No",
                processedBy: ((_b = returnItem.processedBy) === null || _b === void 0 ? void 0 : _b.fullname) || "N/A",
                approvedBy: ((_c = returnItem.approvedBy) === null || _c === void 0 ? void 0 : _c.fullname) || "N/A",
        ...
        summaryWorksheet.addRow([
            ...
            summary.totalSalesItems.toLocaleString("en-US"),
            `-${summary.totalReturnItems.toLocaleString("en-US")}`,
            (summary.totalSalesItems - summary.totalReturnItems).toLocaleString("en-US"),
        ...
        summaryWorksheet.addRow([
            ...
            `₱${(summary.outstandingBalances - summary.totalReturnValue).toLocaleString("en-US", {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2,
            })}`,
        ...
        summaryWorksheet.mergeCells(paymentTermsHeaderRow, 1, paymentTermsHeaderRow, 9);
        ...
        summaryWorksheet.mergeCells(customerClassHeaderRow, 1, customerClassHeaderRow, 9);
        ...
        Object.entries(breakdowns.customerClassification).forEach(([classification, data]) => {
            summaryWorksheet.addRow([
                classification,
                data.count,
                `₱${data.value.toLocaleString("en-US", {
        ...
        summaryWorksheet.mergeCells(returnAnalysisHeaderRow, 1, returnAnalysisHeaderRow, 9);
        ...
        summaryWorksheet.mergeCells(returnStatusHeaderRow, 1, returnStatusHeaderRow, 9);
        ...
        // Save the workbook
        const reportsDir = path_1.default.join(process.cwd(), "public/reports/sales");
        ...
        if (fs_1.default.existsSync(filePath)) {
            throw new Error(`A sales report for the date range ${dateFromFormatted} to ${dateToFormatted} already exists. Please delete the existing file first or use a different date range.`);
        }
        try {
        ...
        (0, SuccessHandler_1.successHandler)({ message: "Excel report generated", url: downloadUrl }, res, "GET", "Sales report generated and saved successfully");
        return;
    }
    (0, SuccessHandler_1.successHandler)({
        ...
        sales,
        salesReturns,
    }, res, "GET", "Sales report generated successfully");
}));
exports.getSalesReportFiles = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, SuccessHandler_1.successHandler)({ files: reportFiles }, res, "GET", "Sales report files retrieved successfully");
    }
    catch (error) {
        throw new Error(`Failed to read report files: ${error.message}`);
    }
}));
exports.downloadAndDeleteSalesReport = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
